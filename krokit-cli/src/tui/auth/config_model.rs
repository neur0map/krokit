...
impl ModalModel {
    pub fn new(available_models: Vec<String>, config: KrokitConfig, providers: Vec<ProviderInfo>, provider: ProviderInfo, env_values: HashMap<String, String>) -> Self {

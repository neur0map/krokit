...
use krokit_llm::client::LlmClient;
...
impl ModalEnvs {
    pub fn new(config: KrokitConfig, providers: Vec<ProviderInfo>, provider: ProviderInfo) -> Self {
    ...
    pub fn extract_state(self) -> (KrokitConfig, Vec<ProviderInfo>, ProviderInfo, HashMap<String, String>) {

...
pub static KROKIT_YELLOW: (u8, u8, u8) = (249,188,81);
pub static KROKIT_GREEN: (u8, u8, u8)  = (18,200,124);
pub static KROKIT_BLUE: (u8,u8,u8) = (148,220,239);
pub static KROKIT_WHITE: (u8,u8,u8) = (200,200,200);
